...
public class MathUtils {
    ...
    private static final String[] names = {
    		"Rick", "Alex", "Allan", "Joe", "Artur", "Johny", "Eric"
    };
    
    public static String getRandomName() {
    	return names[MyRandom.nextInt(names.length)];
    }
	...
	static com.paleon.maths.altvecmath.Transform transform = new com.paleon.maths.altvecmath.Transform();
	...
	public static Matrix4f getModelMatrix(Matrix4f matrix, Vector3f offset, float rotX, float rotY, float rotZ, float scale){
		...
		Matrix4f.rotate(rotX * DEGREES_TO_RADIANS, AXIS_X, matrix, matrix);
		Matrix4f.rotate(rotY * DEGREES_TO_RADIANS, AXIS_Y, matrix, matrix);
		Matrix4f.rotate(rotZ * DEGREES_TO_RADIANS, AXIS_Z, matrix, matrix);
